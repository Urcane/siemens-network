	...
	<div class="modal-dialog modal-dialog-centered mw-650px">
		<div class="modal-content">
			<div class="modal-header py-3">
				<h5 class="fw-bolder">Edit User</h5>
				<div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
					<i class="fas fa-times"></i>
				</div>
			</div>
			<div class="modal-body mx-5 mx-xl-15 my-7">
				<form id="kt_modal_edit_user_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
					@csrf
					...
					<div class="row mb-9">
						...
						<div class="col-xl-12 mb-6">
							...
							<select class="form-select form-select-solid" data-control="select2" multiple required name="site_region_id[]" id="site_region_id_edit" data-dropdown-parent="#kt_modal_edit_user" tabindex="-1">
					...
					<div class="text-center">
						<button type="reset" id="kt_modal_edit_user_cancel" class="btn btn-sm btn-light me-3 w-xl-200px" data-bs-dismiss="modal">Cancel</button>
						<button type="submit" id="kt_modal_edit_user_submit" class="btn btn-sm btn-primary w-xl-200px">
